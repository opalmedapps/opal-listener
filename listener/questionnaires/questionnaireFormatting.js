...
async function getAllowedRespondents(userId, patientSerNum) {
    ...
    let canAccessQuestionnairesList = QuestionnaireDjango.caregiverCanAccessQuestionnairesList(relationships);
    ...
    if (canAccessQuestionnairesList) allowedRespondents.push(questionnaireConfig.QUESTIONNAIRE_RESPONDENT_ID.PATIENT);
