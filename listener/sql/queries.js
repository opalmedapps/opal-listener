...
exports.patientEducationalMaterialTableFields=function()
{
    ...
    AND EduControl.EducationalMaterialType_EN in ('Booklet', 'Factsheet', 'Treatment Guidelines', 'Video') AND Users.Username = ? AND (EduMat.LastUpdated > ? OR EduControl.LastUpdated > ? OR Phase.LastUpdated > ? OR TOC.LastUpdated > ?) order by FIELD(PhaseName_EN,'Prior To Treatment','During Treatment','After Treatment') ;";
};
