...
describe('Request Handler', function () {
    ...
    describe('processRequest()', function () {
        it('Should throw error when trying to process request when Firebase is not initialize', async function () {
            const requestHandler = new RequestHandler({});
            return expect(await requestHandler.processRequest('api', {})).to.throw;
        });
    });
});
