...
if ( isset($_GET["PatientId"]) && isset($_GET["LastName"])) {
	$SearchCondition="PatientId LIKE '% " . $_GET["PatientId"] ."%'AND LastName LIKE '%" . $_GET["LastName"]."%'";
}
 else if ( isset($_GET["PatientId"]) &&  !isset($_GET["LastName"]) ) {
 	$SearchCondition="PatientId LIKE '%". $_GET["PatientId"]."%'";

}
 else if ( !isset($_GET["PatientId"]) &&  isset($_GET["LastName"]) ) {
 	$SearchCondition="LastName LIKE '%". $_GET["LastName"]."%'";
